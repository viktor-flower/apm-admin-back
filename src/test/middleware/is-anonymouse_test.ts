...
import { BaseHttpController, cleanUpMetadata, controller, httpGet, interfaces } from 'inversify-express-utils'
import Controller = interfaces.Controller
import request from 'supertest'
import { Application } from 'express'

describe('Middleware IsAnonymouse', () => {
  ...
  const isAuthenticatedMiddleware = container.get<IsAuthentiticatedMiddleware>(CType.Middleware.IsAuthenticated)
  ...
  before(() => {
    cleanUpMetadata()
    @controller('/test', CType.Middleware.IsAnonymouse)
